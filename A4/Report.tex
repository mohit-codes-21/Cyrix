...
\noindent \texttt{void} variables can be declared but cannot be assigned or used in expressions or conditions.
...
Mohit & \textit{SDT for basic constructs; type checking and implicit casting logic; IR output formatting and output verification.} \\[0.5cm]
